...
#pragma region Model Positioning
	...
	{
		m_m4Creeper = glm::translate(m_m4Creeper, vector3(-fSpeed, 0.0f, 0.0f));
	}
	...
	{
		if(bModifier)
			m_m4Creeper = glm::translate(m_m4Creeper, vector3(0.0f, 0.0f,-fSpeed));
		else
			m_m4Creeper = glm::translate(m_m4Creeper, vector3(0.0f, fSpeed, 0.0f));
	}
